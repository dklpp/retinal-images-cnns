...
# Plot helper
# ----------------------------
def plot_curve(train_values, test_values, ylabel, title, save_path):
    plt.figure()
...
def main(args):
    ...
    # TensorBoard
    run_name = f"densenet_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="DenseNet Classifier for Retina/Choroid")
